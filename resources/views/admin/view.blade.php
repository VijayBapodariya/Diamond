                  ...
                  <tr role="row" class="odd">
                      ...
                      <td>
                            <div class="btn-group">
                                ...
                                @endif
                                @if(Session::get('role')=='Admin')
                                  {{-- <form method="post" action="{{url('admin/'.$value['_id'])}}">
                                    @csrf
                                    @method('DELETE')
                                      <button class="btn btn-outline-danger delete-confirm" type="submit" title="delete" data-original-title="Delete"><i class="mdi mdi-delete" style="font-size:20px;"></i></button>
                                  </form> --}}
