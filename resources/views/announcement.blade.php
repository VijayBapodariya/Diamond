      ...
      <div class="card-body">
        ...
        <form method="post" action="{{ url('announcements/')}}">
          ...
          <div class="form-group d-flex">
            ...
            <div class="col-sm-6">
                <input type="tetx" class="form-control ui-autocomplete-input @error('amount') is-invalid @enderror" id="exampleInputUsername1"  value="{{$data['announcement']}}" name="amount" autocomplete="off">
                @error('amount')
