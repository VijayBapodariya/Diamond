...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">distributer</h6>
            ...
            <tbody>
              ...
              @foreach($data as $value)
                  <tr role="row" class="odd">
                      ...
                      <td>
                            <div class="btn-group">
                                <a href="{{ url('distributer/edit/'.$value['_id'])}}" type="button" class="btn btn-outline-info" title="Edit user"><i class="mdi mdi-pencil-box" style="font-size:20px;"></i></a>
                                ...
                                @if($value['isActive']==1)
                                  <a href="{{ url('banuser/'.$value['_id'].'/'.$value['isActive'])}}" class="btn btn-outline-success" title="Ban User"><i class="mdi mdi-close-box" style="font-size:20px;"></i></a>
                                @elseif($value['isActive']==0)
                                  <a href="{{ url('banuser/'.$value['_id'].'/0')}}" class="btn btn-outline-danger" title="UnBan User"><i class="mdi mdi-checkbox-marked" style="font-size:20px;"></i></a>
                                @endif
