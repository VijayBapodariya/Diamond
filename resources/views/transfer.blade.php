                ...
                <tbody id="pending">
                    ...
                    @foreach($pending_accept as $pa)
                        <tr>
                            ...
                            <th>
                                <a href="{{url('success/'.$pa['_id'])}}" class="btn btn-outline-success" title="Accept">Accept</a>
                                <a href="{{url('reject/'.$pa['_id'])}}" class="btn btn-outline-danger delete-confirm" title="Reject">Reject</a>
                            </th>
                        </tr>
                    @endforeach
                </tbody>
    ...
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <div class="table-responsive">
              <table id="dataTableExample1" class="table table-bordered display" >
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>UserName</th>
                        ...
                        <tr>
                            ...
                            <th>
                                @if($pa['status']=="success")
                                    <span  title="Ban User">Transfer <span class="text-success">Success</span></span>
                                @elseif($pa['status']=="pending")
                                    <span title="Ban User">Transfer <span class="text-primary">Pending</span></span>
                                @elseif($pa['status']=="rejected")
                                    <span title="Ban User">Transfer <span class="text-danger">Reject</span></span>
                                @endif
                            </th>
                        </tr>
                    @endforeach
