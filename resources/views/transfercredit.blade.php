  ...
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form method="post" action="{{ url('transfercredits/'.$data['_id'])}}">
            @csrf
          ...
          <div class="form-group d-flex">
            <label class="col-sm-2 offset-lg-1 text-right control-label mt-2">Amount to Transfer</label>
            <div class="col-sm-6">
          ...
          <div class="form-group d-flex">
            ...
            <div class="col-sm-6">
                <button type="submit" class="btn btn-primary">Credit Transfer</button>
            </div>
          </div>
        </form>
      </div>
